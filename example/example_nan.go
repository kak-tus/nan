// Code generated by "nan -pkg example -json -jsoniter -easyjson -sql -cql ../../example/structs.go ../../example/structs_easyjson.go"; DO NOT EDIT.
...
func (n *NullMyStruct) Scan(value interface{}) error {
	...
	*n = NullMyStruct{Valid: true, MyStruct: val}
...
func (n NullMyStruct) MarshalCQL(info gocql.TypeInfo) ([]byte, error) {
	...
	return n.MyStruct.MarshalCQL(info)
}
