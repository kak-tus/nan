...
func easyjson84ae5f89DecodeGithubComKakTusNan(in *jlexer.Lexer, out *valuesSmall) {
...
func easyjson84ae5f89EncodeGithubComKakTusNan(out *jwriter.Writer, in valuesSmall) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v valuesSmall) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson84ae5f89EncodeGithubComKakTusNan(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v valuesSmall) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson84ae5f89EncodeGithubComKakTusNan(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *valuesSmall) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson84ae5f89DecodeGithubComKakTusNan(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *valuesSmall) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson84ae5f89DecodeGithubComKakTusNan(l, v)
}
