...
func easyjson4cedfeDecodeGithubComKakTusNan(in *jlexer.Lexer, out *pointerBig) {
...
func easyjson4cedfeEncodeGithubComKakTusNan(out *jwriter.Writer, in pointerBig) {
	out.RawByte('{')
	first := true
	_ = first
	{
