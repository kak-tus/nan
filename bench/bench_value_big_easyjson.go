...
func easyjson8e3959a1DecodeGithubComKakTusNanBench(in *jlexer.Lexer, out *valueBig) {
...
func easyjson8e3959a1EncodeGithubComKakTusNanBench(out *jwriter.Writer, in valueBig) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v valueBig) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8e3959a1EncodeGithubComKakTusNanBench(&w, v)
...
func (v *valueBig) UnmarshalJSON(data []byte) error {
	...
	easyjson8e3959a1DecodeGithubComKakTusNanBench(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *valueBig) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8e3959a1DecodeGithubComKakTusNanBench(l, v)
}
