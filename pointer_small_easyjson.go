...
func easyjson567186c1DecodeGithubComKakTusNan(in *jlexer.Lexer, out *pointersSmall) {
...
func easyjson567186c1EncodeGithubComKakTusNan(out *jwriter.Writer, in pointersSmall) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v pointersSmall) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson567186c1EncodeGithubComKakTusNan(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v pointersSmall) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson567186c1EncodeGithubComKakTusNan(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *pointersSmall) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson567186c1DecodeGithubComKakTusNan(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *pointersSmall) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson567186c1DecodeGithubComKakTusNan(l, v)
}
